...
class SupervisiNoteSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= $total; $i++) {
            ...
            $row['notes'] = 'This is a sample note for Supervisi Note module. ' . $i;

            $rows[] = $row;

            // ✅ Insert per 200/1000 kalau datanya gede. Di contoh ini 20 cukup.
            if (count($rows) >= 200) {
                SupervisiNote::insert($rows);
                $rows = [];
            }
        }
