...
<table class="table table-striped @if ($isYajra || $isAjaxYajra) yajra-datatable @endif"
  ...
  <thead>
    <tr>
      ...
      <th>{{ __('validation.attributes.full_name') }}</th>
		<th>{{ __('validation.attributes.phone_number') }}</th>
		<th>{{ __('validation.attributes.lokasi_keberangkatan') }}</th>
		<th>{{ __('validation.attributes.alamat_tujuan') }}</th>
		<th>{{ __('validation.attributes.car_type') }}</th>
		<th>{{ __('validation.attributes.tgl_penggunaan') }}</th>
		<th>{{ __('validation.attributes.perkiraan_jam') }}</th>
		<th>{{ __('validation.attributes.additional_notes') }}</th>
  ...
  <tbody>
    @if ($isYajra === false)
      @foreach ($data as $item)
		...
		<td>{{ $item->lokasi_keberangkatan }}</td>
		<td>{{ $item->alamat_tujuan }}</td>
		<td>{{ $item->car_type }}</td>
		<td>{{ $item->tgl_penggunaan }}</td>
		<td>{{ $item->perkiraan_jam }}</td>
