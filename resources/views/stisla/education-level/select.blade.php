@extends('stisla.layouts.app-top-nav')
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Pilih Jenjang Pendidikan</h4>
            </div>
            <div class="card-body">
              <div class="row mt-4">
                <div class="col-12 col-lg-8 offset-lg-2">
                  <div class="wizard-steps">
                    @foreach ($levels as $level)
                      <div class="wizard-step wizard-step-active" style="cursor: pointer;" onclick="window.location.href='{{ route('set-education-level', ['education_level_id' => $level->id]) }}'">
              ...
              {{-- <div class="text-center mt-3">
                <a href="#" class="btn btn-icon icon-right btn-primary">Simpan <i class="fas fa-arrow-right"></i></a>
              </div> --}}
              {{-- <div class="row mt-4">
                <div class="col-12 col-lg-8 offset-lg-2">
                  <div class="wizard-steps">
