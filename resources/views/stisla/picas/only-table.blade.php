...
<table class="table table-striped @if ($isYajra || $isAjaxYajra) yajra-datatable @endif"
  ...
  <thead>
    <tr>
      ...
      <th>{{ __('validation.attributes.work_field_id') }}</th>
      <th>{{ __('validation.attributes.deadline') }}</th>
      <th>{{ __('validation.attributes.kpi_related') }}</th>
      <th>{{ __('validation.attributes.assigned_to') }}</th>
