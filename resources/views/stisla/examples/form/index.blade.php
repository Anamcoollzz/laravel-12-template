                ...
                <div class="col-6 col-sm-4">
                  <label class="imagecheck mb-4">
                    ...
                    <figure class="imagecheck-figure">
                      <img src="{{ 'stisla/assets/img/news/img01.jpg' }}" alt="}" class="imagecheck-image">
                    </figure>
                  </label>
                </div>
                <div class="col-6 col-sm-4">
                  <label class="imagecheck mb-4">
                    ...
                    <figure class="imagecheck-figure">
                      <img src="{{ 'stisla/assets/img/news/img02.jpg' }}" alt="}" class="imagecheck-image">
                    </figure>
                  </label>
                </div>
                <div class="col-6 col-sm-4">
                  <label class="imagecheck mb-4">
                    ...
                    <figure class="imagecheck-figure">
                      <img src="{{ 'stisla/assets/img/news/img03.jpg' }}" alt="}" class="imagecheck-image">
                    </figure>
                  </label>
                </div>
                <div class="col-6 col-sm-4">
                  <label class="imagecheck mb-4">
                    ...
                    <figure class="imagecheck-figure">
                      <img src="{{ 'stisla/assets/img/news/img04.jpg' }}" alt="}" class="imagecheck-image">
                    </figure>
                  </label>
                </div>
                <div class="col-6 col-sm-4">
                  <label class="imagecheck mb-4">
                    ...
                    <figure class="imagecheck-figure">
                      <img src="{{ 'stisla/assets/img/news/img05.jpg' }}" alt="}" class="imagecheck-image">
                    </figure>
                  </label>
                </div>
                <div class="col-6 col-sm-4">
                  <label class="imagecheck mb-4">
                    ...
                    <figure class="imagecheck-figure">
                      <img src="{{ 'stisla/assets/img/news/img06.jpg' }}" alt="}" class="imagecheck-image">
                    </figure>
                  </label>
                </div>
              </div>
