...
@section('content')
  <section class="section">
    ...
    <div class="section-body">
      ...
      <p class="section-lead">Menampilkan halaman yang sedang dalam pengembangan.</p>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="empty-state" data-height="600">
                <img class="img-fluid" src="{{ asset('stisla') }}/assets/img/drawkit/drawkit-nature-man-colour.svg" alt="image" style="max-width: 400px;">
                <h2 class="mt-0">Lagi nunggu ya?</h2>
                <p class="lead">
                  Maaf, halaman ini sedang dalam pengembangan. Kami akan segera menghadirkannya untuk Anda.
                </p>
                <a href="#" class="btn btn-warning mt-4">Coba Lagi</a>
      ...
      {{-- <div class="row">
        <div class="col-12 col-md-6 col-sm-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="empty-state" data-height="600">
                <img class="img-fluid" src="{{ asset('stisla') }}/assets/img/drawkit/drawkit-full-stack-man-colour.svg" alt="image">
        ...
        <div class="col-12 col-md-6 col-sm-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="empty-state" data-height="600">
                <img class="img-fluid" src="{{ asset('stisla') }}/assets/img/drawkit/drawkit-nature-man-colour.svg" alt="image">
