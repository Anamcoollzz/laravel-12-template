    ...
    @if ($isYajra === false)
      @foreach ($data as $item)
        <tr>
          ...
          @else
            <td>
              @include('stisla.works.image', ['file' => $item->avatar])
            </td>
          @endif
          <td>{{ $item->text }}</td>
          @if ($isExport)
          ...
          @else
            <td>
              @include('stisla.works.file', ['file' => $item->file])
            </td>
            <td>
              @include('stisla.works.image', ['file' => $item->image])
            </td>
          @endif
          ...
          <td>{{ $item->time }}</td>
          <td>
            @include('stisla.works.color', ['color' => $item->color])
          </td> --}}
