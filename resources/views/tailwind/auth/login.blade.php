...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
  ...
  <div class="bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-[1280px] min-h-[680px] flex flex-col md:flex-row">
    ...
    <div class="md:w-1/2 p-8 md:p-20 bg-gradient-to-br from-blue-600 to-blue-400 flex flex-col items-center justify-center">
      ...
      <img src="{{ url('assets/disdik') }}/draw2.webp" alt="Ilustrasi" class="w-full max-w-sm float-animation drop-shadow-xl">
    </div>
    ...
    <div class="w-full md:w-1/2 p-10 md:p-20 flex flex-col justify-center">
      ...
      <div class="flex justify-center gap-4 mb-6">
        ...
        <a href="https://disdik.majalengkakab.go.id/" class="bg-sky-400 text-white w-20 h-20 rounded-full flex items-center justify-center hover:bg-sky-500">
